...
//javabeat.net.util.java
public class Hw3 {
	/**
	This program:
	     reads data records from sortData.cvs file into a static array
	     displays the time used to sort the records stored in the static array by the last name
	Assumption: 
	     Max. 5,000 records
	Input Data file: 
	     sortData.csv
	**/
	...
	public static void main(String [] args)
	  ...
	  int cnt=0;
	  try {
		  //Scanner inFile = new Scanner (new file ("sortData.csv"));
